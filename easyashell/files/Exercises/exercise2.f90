...
!    WRITE(*,*) 'ifile = ',ifile
  ...
  ELSE ! ilfile esiste -> diverse opzioni
    ...
    IF ((IACHAR(risposta)<=57).AND.(IACHAR(risposta)>=48)) THEN !se risposta è un numero 
      READ(risposta,*) nrisposta !trasformo il carattere nel numero
      ...
      ELSE !se risposta non è un numero torno a inizio DO
         WRITE (*,*)'Puoi rispondere solo un numero : 1 , 2, o 3'
      END IF
  END IF esistenza
